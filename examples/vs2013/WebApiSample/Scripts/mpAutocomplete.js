(function () {
    ...
    angular
        .module('mpDirectives', [])
        .directive('mpAutocomplete', mpAutocomplete);

    mpAutocomplete.$inject = ['$http', '$interpolate', '$parse'];
    function mpAutocomplete($http, $interpolate, $parse) {

        // Usage:

        //  For a simple array of items
        //  <input type="text" class="form-control" mp-autocomplete url="/some/url" ng-model="criteria.employeeNumber"  />

        //  For a simple array of items, with option to allow custom entries
        //  <input type="text" class="form-control" mp-autocomplete url="/some/url" allow-custom-entry="true" ng-model="criteria.employeeNumber"  />

        //  For an array of objects, the label attribute accepts an expression.  NgModel is set to the selected object.
        //  <input type="text" class="form-control" mp-autocomplete url="/some/url" label="{{lastName}}, {{firstName}} ({{samAccountName}})" ng-model="criteria.employeeNumber"  />

        //  Setting the value attribute will set the value of NgModel to be the property of the selected object.
        //  <input type="text" class="form-control" mp-autocomplete url="/some/url" label="{{lastName}}, {{firstName}} ({{samAccountName}})" value="id" ng-model="criteria.employeeNumber"  />
